...
## <a name="include-no-locblazor-extensibility"></a>Einschließen von Blazor-Erweiterbarkeit
...
### <a name="no-locrazor-views-or-no-locrazor-pages"></a>Razor-Ansichten oder Razor-Seiten
