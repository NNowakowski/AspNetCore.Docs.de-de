...
## <a name="samesite-and-no-locidentity"></a>SameSite undIdentity
...
| [CookieGenehmigung](xref:Microsoft.Extensions.DependencyInjection.CookieExtensions.AddCookie*) | [CookieAuthenticationoptions.Cookie](xref:Microsoft.AspNetCore.Builder.CookieAuthenticationOptions.CookieName) | `Lax` |
...
### <a name="test-with-no-locelectron"></a>Testen mitElectron
